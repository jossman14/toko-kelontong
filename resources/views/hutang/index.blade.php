...
@endif
    <a class="btn btn-primary" href="{{route("hutang.create")}}" role="button">Tambah Barang</a>
    <table class="table">
        <thead>
          <tr>
            <th scope="col">No.</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
    <a class="btn btn-outline-dark" href="{{route("hutang.edit", $item->id)}}" role="button">Edit</a>


    <form action="{{ route("hutang.destroy", $item ) }}" method="post"
