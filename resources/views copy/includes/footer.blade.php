        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copy-right">
                    <p>Copyright &#169; 2021 Mas Woko. All rights reserved</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- peity JS
============================================ -->
<script src="{{ asset('template/js/peity/jquery.peity.min.js') }}"></script>
...
<!-- flot JS
============================================ -->
<script src="{{ asset('template/js/flot/Chart.min.js') }}"></script>
<script src="{{ asset('template/js/flot/dashtwo-flot-active.js') }}"></script>
<!-- data table JS
============================================ -->
